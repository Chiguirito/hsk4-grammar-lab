...
Two reasons. Literal: the word-ordering task loves 走进教室去-type chains. Abstract: Reading and Listening lean hard on 看起来, 停下来, 说下去, 想出来, 醒过来 — direction words recycled as pure ideas. Both live on this page.</div>`
    ...
    /* ------------------------------------------------ 3 */
    {
      ...
      items: [
        ...
        { tag: "起来", cn: "请大家站**起来**，我们先做个游戏。", py: "Qǐng dàjiā zhàn qǐlái, wǒmen xiān zuò gè yóuxì.", en: "Everyone please stand up — let's play a game first.", note: "起来 = up off the seat. Remember: no 起去." },
...
<p>Bonus: time itself uses this tail — <span class="zh">冬天过去了，春天来了。</span> Past events drift away from now, which is why “the past” is <span class="zh">过去</span>.</p>`,
    ...
    /* ------------------------------------------------ 7 */
    {
      ...
      rows: [
        ['<span class="zh"><b class="hl">想起来</b> vs <b class="hl">想出来</b> (vs 想到)</span>', '<span class="zh">想起来</span> = <b>recall</b> what was already in your head: 我想起来他的名字了。 <span class="py-hint">Wǒ xiǎng qǐlái tā de míngzi le.</span>', '<span class="zh">想出来</span> = <b>invent</b> something new: 他想出来一个好办法。 <span class="py-hint">Tā xiǎng chūlái yí gè hǎo bànfǎ.</span> — And <span class="zh">想到</span> = it crossed your mind at all: 没想到你也来了！'],
    ...
    /* ------------------------------------------------ 8 */
    {
      ...
      items: [
        ...
        { wrong: "天开始下雨起来了。", right: "天下起雨来了。", py: "Tiān xià qǐ yǔ lái le.", en: "It started to rain.", expl: "Two bugs in one: the start-meaning 起来 already contains 'begin' (don't add 开始), and the object 雨 must split the tail: 下起雨来." },
        ...
        { wrong: "我想起来了一个特别好的新办法。", right: "我想出来了一个特别好的新办法。", py: "Wǒ xiǎng chūlái le yí gè tèbié hǎo de xīn bànfǎ.", en: "I came up with a really good new idea.", expl: "新办法 = it never existed before, so it's produced, not recalled: 想出来. 想起来 needs an old memory." },
...
Word-ordering algorithm: ① verb + path tile first; ② any PLACE glues before 来/去; ③ 把 + definite object stacks before the verb; ④ 了 goes last. For meaning questions, ask: old memory (起来)? new product (出来)? toward now (下来)? into future (下去)? back to normal (过来)?</div>`
    ...
    /* ------------------------------------------------ 11 */
    {
      ...
      items: [
        ...
        { q: '<span class="zh">这本小说太无聊了，我实在看不___了。</span>', choices: ['<span class="zh">下来</span>', '<span class="zh">起来</span>', '<span class="zh">下去</span>', '<span class="zh">出来</span>'], a: 2, expl: "Can't CONTINUE reading into the future → 下去. 下来 looks backward; it can't follow 看不 here." },
        ...
        { q: '<span class="zh">他一开口，我就听___他是南方人。</span>', choices: ['<span class="zh">起来</span>', '<span class="zh">出来</span>', '<span class="zh">下来</span>', '<span class="zh">进去</span>'], a: 1, expl: "Hidden information (where he's from) extracted from his speech = detect 听出来. 听起来 would give an impression: 听起来像南方人." },

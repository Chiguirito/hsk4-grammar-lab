...
Word-ordering algorithm: ① verb + path tile first; ② any PLACE glues before 来/去; ③ 把 + definite object stacks before the verb; ④ 了 goes last. For meaning questions, ask: old memory (起来)? new product (出来)? toward now (下来)? into future (下去)? back to normal (过来)?</div>`
    ...
    /* ------------------------------------------------ 11 */
    {
      ...
      items: [
        ...
        { q: "<span class=\"zh\">快递到楼下了，你在家等着，我___拿。</span>", choices: ["<span class=\"zh\">下去</span>", "<span class=\"zh\">下来</span>", "<span class=\"zh\">上去</span>", "<span class=\"zh\">过来</span>"], a: 0, expl: "Both speakers are up in the apartment; the speaker moves down and AWAY from where they stand → 下去. 下来 is the classic perspective flip — it would only work said by someone already waiting downstairs." },
        { q: "<span class=\"zh\">这位亲戚我只在小时候见过，现在他站在我面前，我都认不___了。</span>", choices: ["<span class=\"zh\">出来</span>", "<span class=\"zh\">起来</span>", "<span class=\"zh\">下去</span>", "<span class=\"zh\">过来</span>"], a: 0, expl: "Matching the face in front of you to a hidden identity = detect-出来: 认不出来. 起来 tempts because of 想不起来, but recall-起来 retrieves memories — 认 pairs with 出来, never 起来." },
      ]
    },

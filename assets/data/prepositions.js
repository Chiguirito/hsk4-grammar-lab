...
“<b>Except for</b> Xiao Li, we all went” (exclusion) vs “<b>Besides</b> Chinese, she also speaks French” (addition). English changes the preposition; Chinese keeps 除了 and changes the adverb. Map except→都, besides→还/也 and you'll never mistranslate again.</div>`
    ...
    /* ------------------------------------------------ 6 */
    {
      ...
      items: [
        { q: '“I studied Chinese in Beijing.” Which is correct?', choices: ['<span class="zh">我学了两年中文在北京。</span>', '<span class="zh">我在北京学了两年中文。</span>', '<span class="zh">在北京我学了两年中文在。</span>', '<span class="zh">我学在北京了两年中文。</span>'], a: 1, expl: "The [在 + place] block parks BEFORE the verb. Putting it after (option A) is the eternal English-order error." },

...
“<b>Except for</b> Xiao Li, we all went” (exclusion) vs “<b>Besides</b> Chinese, she also speaks French” (addition). English changes the preposition; Chinese keeps 除了 and changes the adverb. Map except→都, besides→还/也 and you'll never mistranslate again.</div>`
    ...
    /* ------------------------------------------------ 7 */
    {
      ...
      short: "Error clinic",
      intro: "Some patients have position disease, the rest picked the wrong twin. One bug each.",
      items: [
    ...
    /* ------------------------------------------------ consolidation */
    {
      ...
      items: [
        ...
        { tag: "对…来说", cn: "**对**儿童**来说**，养成饭前洗手的习惯很关键。", py: "Duì értóng lái shuō, yǎngchéng fàn qián xǐ shǒu de xíguàn hěn guānjiàn.", en: "For children, developing the habit of washing their hands before meals is crucial.", note: "对…来说 — the lighter 'for X' frame, fine for people. 对于…来说 is its formal twin." },
        { tag: "按照", cn: "**按照**新的时间表，我们每天早上八点开始上课。", py: "Ànzhào xīn de shíjiānbiǎo, wǒmen měi tiān zǎoshang bā diǎn kāishǐ shàngkè.", en: "Under the new timetable, classes start at eight every morning.", note: "A timetable is a plan you carry out day by day → 按照 fits best (根据 would also pass here). The contrast only cuts hard the other way: ✗按照天气预报." },
      ]
    },
...
Ordering task: any tile starting with 在/跟/给/对/按照/根据/随着/为了 is a pre-verb block — find the verb tile and park the block LEFT of it. Only 在/到/给 may ride behind the verb, and only when the sentence is about where something ends up.</div>`
    ...
    /* ------------------------------------------------ 10 */
    {
      ...
      short: "Final drill",
      intro: "The near-twins (对/对于, 通过/经过, 按照/根据, 由/被, 为/为了) are all in here — with their sneakiest disguises.",
      items: [

...
① A 却/倒 tile? It must snap BETWEEN a subject and a verb — find that subject. ② A 但是/不过/然而 tile? It opens clause 2. ③ A 虽然/尽管/即使 tile? It opens clause 1 (or follows the shared subject). ④ Check the couples: 即使↔也, 尽管↔还是/但是, 虽然↔但是.</div>`
    ...
    /* ------------------------------------------------ 7 */
    {
      ...
      items: [
        { q: "Which sentence is correct?", choices: ["我等了很久，却他没来。", "我等了很久，他却没来。", "我等了很久，他没来却。", "我却等了很久，他没来。"], a: 1, expl: "却 is an adverb: after the subject 他, before 没来. Clause-initial ✗却他没来 is THE classic trap." },
    ...
    /* ------------------------------------------------ 9 */
    {
      ...
      items: [
        ...
        { tiles: ["即使", "票", "再贵", "我", "也", "要", "去看", "这场比赛"], py: "Jíshǐ piào zài guì, wǒ yě yào qù kàn zhè chǎng bǐsài.", en: "Even if the tickets are ever so expensive, I still want to go see this match.", hint: "即使's partner 也 lives after 我.", alt: [["票", "即使", "再贵", "我", "也", "要", "去看", "这场比赛"]] },
...
虽然/尽管 ↔ 但是·可是·还是·却 (facts) &nbsp;·&nbsp; 即使/就算/哪怕 ↔ 也 (hypotheses) &nbsp;·&nbsp; ✗虽然…所以 &nbsp;·&nbsp; ✗即使…但是 &nbsp;·&nbsp; ✗clause-initial 却/倒. Run this checklist and half the reading section pays out.</div>`
    ...
    /* ------------------------------------------------ 11 */
    {
      ...
      items: [
        ...
        { q: "<span class=\"zh\">妹妹平时很害羞，关键时刻___表现得特别勇敢。</span>", choices: ["<span class=\"zh\">却</span>", "<span class=\"zh\">但是</span>", "<span class=\"zh\">然而</span>", "<span class=\"zh\">就算</span>"], a: 0, expl: "The blank sits INSIDE clause 2 — after 关键时刻, directly before the verb 表现. That's an adverb slot, so only **却** fits. 但是/然而 must stand at the head of the clause, before 关键时刻; 就算 opens a hypothetical clause 1 and would demand 也." },
        { q: "<span class=\"zh\">___你现在乘出租车去机场，___赶不上八点的飞机了。</span>", choices: ["<span class=\"zh\">即使 / 也</span>", "<span class=\"zh\">虽然 / 但是</span>", "<span class=\"zh\">不管 / 都</span>", "<span class=\"zh\">尽管 / 还是</span>"], a: 0, expl: "Taking a taxi is ONE imagined case, conceded in advance → **即使…也**. 不管/都 needs an open variable (谁/什么/A还是B) — there is none here. 虽然 and 尽管 concede real facts, but this ride hasn't happened; fact-couples with 但是/还是 break the logic." },
      ]
    },

...
Counts and durations use 两: <span class="zh">两次、两遍、两年、两个小时</span> — never ✗二次. You knew this from measure words; it applies to every complement on this page.</div>`
    ...
    /* ------------------------------------------------ 7 */
    {
      ...
      items: [
        ...
        { wrong: "他每天睡觉以前都阅读了半个小时。", right: "他每天睡觉以前都阅读半个小时。", py: "Tā měitiān shuìjiào yǐqián dōu yuèdú bàn ge xiǎoshí.", en: "He reads for half an hour every night before going to bed.", expl: "每天…都 marks a routine, and routines refuse 了 — 了 seals off ONE finished occasion, which clashes with something that repeats. The duration still trails the verb: 阅读**半个小时**, just with no 了." },
      ]
    },
...
Ordering task with a 三年/两次/一趟 tile? ① Find the verb. ② Is there a 了/过 tile? Glue it to the verb. ③ Pronoun object → straight after the verb, tail last. Noun object → look for a second copy of the verb or a 的; that tells you which layout the item wants.</div>`
    ...
    /* ------------------------------------------------ 10 */
    {
      ...
      items: [
        ...
        { q: "Which sentence is correct?", choices: ["<span class=\"zh\">护士给我打针了两次。</span>", "<span class=\"zh\">护士给我打了两次针。</span>", "<span class=\"zh\">护士给我打了针两次。</span>", "<span class=\"zh\">护士两次给我打了针。</span>"], a: 1, expl: "打针 is separable: 针 is its built-in object, so the count wedges INSIDE — 打了**两次**针, exactly like 见过两次面. ✗打针了两次 treats it as one solid verb, ✗打了针两次 strands the tail behind the object, and fronting a bare 两次 is a formal written pattern, not the exam answer." },
        { q: "<span class=\"zh\">他们结婚___，还像刚认识时那么浪漫。</span>", choices: ["<span class=\"zh\">十年了</span>", "<span class=\"zh\">了十年</span>", "<span class=\"zh\">结了十年</span>", "<span class=\"zh\">过十年</span>"], a: 0, expl: "结婚 is an instant verb — you can't 'marry' for ten years. The duration measures time SINCE the wedding and follows the whole verb, with final 了 for 'up to now': 结婚**十年了**. ✗结婚了十年 glues 了 to an instant, and ✗结婚结了十年 copies a verb that can't stretch." },
      ]
    },

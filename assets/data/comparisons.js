...
In the word-arrangement task, a 得 tile plus a 比 tile means a verb comparison. Build the verb chunk first (跑得快), then insert 比+B either before the verb or before the adjective.</div>`
    ...
    /* ------------------------------------------------ 7 */
    {
      ...
      items: [
        ...
        { q: '“I don\'t speak as well as she does.” Best translation?', choices: ['我说得不比她好。', '我说得没有她那么好。', '我不说得她好。', '我说得比她不好。'], a: 1, expl: "'Not as … as' = 没有…(那么). 不比她好 means 'roughly the same'; ✗比她不好 puts 不 in an impossible slot." },

...
Ordering task with a 被 tile: ① the definite "victim" noun goes first; ② 被 + agent next (no agent tile? then 被 hugs the verb); ③ verb + tail; ④ time/negation/modal tiles stack before 被. Mechanical, like 把.</div>`
    ...
    /* ------------------------------------------------ 7 */
    {
      ...
      items: [
        ...
        { q: '<span class="zh">弟弟把我的蛋糕吃光了。</span> = <span class="zh">我的蛋糕___吃光了。</span>', choices: ['<span class="zh">被弟弟</span>', '<span class="zh">把弟弟</span>', '<span class="zh">被</span>', '<span class="zh">给弟弟把</span>'], a: 0, expl: "把→被 mirror: receiver up front, 被 + agent, verb chunk 吃光了 unchanged. Dropping 弟弟 (choice C) is grammatical but loses information — the exam wants the faithful conversion." },
...
English passive → first try topic + result (<span class="zh">写完了</span> style). If the sentence reports a mishap or names a culprit → 被. If it assigns a duty in formal writing → 由. Only these three doors.</div>`
    ...
    /* ------------------------------------------------ 11 */
    {
      ...
      short: "Final drill",
      intro: "Eleven questions at real exam difficulty. The distractors are exactly the clinic's diseases — spot them.",
      items: [
        ...
        { q: '<span class="zh">房间被妹妹打扫干净了。</span> = ?', choices: ['<span class="zh">妹妹把房间打扫干净了。</span>', '<span class="zh">妹妹被房间打扫干净了。</span>', '<span class="zh">房间把妹妹打扫干净了。</span>', '<span class="zh">妹妹把房间干净了。</span>'], a: 0, expl: "被→把 mirror: agent takes the front, 把 + receiver, verb chunk 打扫干净了 travels unchanged. Choice D lost the verb — a tail can't survive alone." },

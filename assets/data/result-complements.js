...
In the word-ordering task, tiles like <span class="zh">翻译成 / 打扫干净 / 关上</span> are pre-welded for you — never try to insert 了 or the object into them. Object goes after, 了 goes after, negation goes way up front.</div>`
    ...
    /* ------------------------------------------------ 10 */
    {
      ...
      items: [
        ...
        { q: '<span class="zh">妈妈说：___作业就不能看电视。</span>', choices: ['<span class="zh">没写完</span>', '<span class="zh">不写完</span>', '<span class="zh">写不完</span>', '<span class="zh">别写完</span>'], a: 1, expl: "The conditional threat pattern: 不 + V完 + 就…. This is the one place 不 legally negates a result complement. 写不完 means 'can't possibly finish' — a different grammar (potential)." },

...
<p>Versus <span class="zh">越来越</span>: both mean gradual change, and often both fit. But <span class="zh">一天比一天</span> insists on the <b>time-unit-by-time-unit</b> rhythm, while <span class="zh">越来越</span> is neutral about how the change happens — and only 越来越 can pair with a verb of feeling (<span class="zh">越来越喜欢</span>). Neither tolerates 很/非常 after it.</p>`,
    ...
    /* ------------------------------------------------ 7 */
    {
      ...
      items: [
        ...
        { q: "Which sentence is correct?", choices: ['<span class="zh">他大约三十岁。</span>', '<span class="zh">他三十岁大约。</span>', '<span class="zh">他大约三十岁左右。</span>', '<span class="zh">大约他三十岁。</span>'], a: 0, expl: "大约 stands before the number, inside the predicate. ✗大约三十岁左右 stacks 大约 AND 左右 — redundant, a classic error-spotting item." },
    ...
    /* ------------------------------------------------ 8 */
    {
      ...
      items: [
        ...
        { wrong: "这次参赛的女性有左右一百人。", right: "这次参赛的女性有一百人左右。", py: "Zhè cì cānsài de nǚxìng yǒu yìbǎi rén zuǒyòu.", en: "About a hundred women took part in the competition.", expl: "左右 is a tail, never a head: it hangs after the COMPLETE number + measure phrase (一百人 + 左右). Fronting it is the English-reflex error ('around 100'). To approximate from the front, switch tools: 大约一百人." },
      ]
    },
...
When a cloze blank touches a number, run the slot check in order: ① before the number? (大约/大概/差不多/好几) ② after number+measure? (左右/上下/多-fraction) ③ inside the number? (来/几/多-whole/adjacent digits). One of the three always settles it.</div>`
    ...
    /* ------------------------------------------------ 11 */
    {
      ...
      items: [
        ...
        { q: "<span class=\"zh\">这家加油站的汽油价格从八块降到了四块，等于降低了___。</span>", choices: ["<span class=\"zh\">一半</span>", "<span class=\"zh\">一倍</span>", "<span class=\"zh\">两倍</span>", "<span class=\"zh\">百分之四十</span>"], a: 0, expl: "8 → 4 is a halving → 降低了**一半**. 倍 only goes UP — ✗降低了一倍/两倍 is always wrong for decreases. And check the math on the percent distractor: the drop is 4/8 = 百分之五十, not 百分之四十." },
        { q: "<span class=\"zh\">工作日的早上路上很堵，坐车去机场___需要一个半小时。</span>", choices: ["<span class=\"zh\">大约</span>", "<span class=\"zh\">左右</span>", "<span class=\"zh\">上下</span>", "<span class=\"zh\">好几</span>"], a: 0, expl: "The blank stands BEFORE the number → only a front-slot word fits: **大约** (or 大概/差不多). 左右/上下 are tails — they'd have to follow the complete phrase (一个半小时左右). 好几 must glue directly onto a measure word or 十/百/千 (好几个小时, 好几百人) — it can't float in front of the verb." },
      ]
    },

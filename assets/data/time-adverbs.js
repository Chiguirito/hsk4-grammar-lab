...
<div class="pattern">Future/plan → <span class="slot">然后</span> only &nbsp;·&nbsp; Past story, time gap → <span class="slot">后来</span><small>✗ 明天我们先去博物馆，后来去吃烤鸭 → ✓ …然后去吃烤鸭</small></div>`,
    ...
    /* ------------------------------------------------ 8 */
    {
      ...
      items: [
        ...
        { wrong: "刚我在食堂看见王老师了，你现在去找他吧。", right: "刚才我在食堂看见王老师了，你现在去找他吧。", py: "Gāngcái wǒ zài shítáng kànjiàn Wáng lǎoshī le, nǐ xiànzài qù zhǎo tā ba.", en: "I saw Mr. Wang in the cafeteria just now — go find him.", expl: "刚 is an adverb and must hug the verb — it can never stand in front of the subject. The sentence-initial slot belongs to the time noun 刚才, which moves like 昨天. (我刚在食堂看见他 would also be correct — 刚 back beside the verb.)" },
      ]
    },
...
<p><span class="zh"><b class="hl">一直</b>往前走，到红绿灯右转。</span> — “keep going straight ahead”. Same 'unbroken line' idea, applied to space. Free bonus point in listening's direction dialogues.</p>`
    ...
    /* ------------------------------------------------ 11 */
    {
      ...
      items: [
        ...
        { q: '<span class="zh">你来得___，我们正说到你呢。</span>', choices: ['<span class="zh">及时</span>', '<span class="zh">准时</span>', '<span class="zh">正好</span>', '<span class="zh">马上</span>'], a: 2, expl: "A happy coincidence, not a rescue and not an appointment → 你来得正好, the set phrase. 及时 would imply you averted some disaster; 准时 needs an agreed time." },
        ...
        { q: "<span class=\"zh\">高考六月七号___开始了，他现在每天都复习到半夜。</span>", choices: ["<span class=\"zh\">快要</span>", "<span class=\"zh\">就要</span>", "<span class=\"zh\">刚才</span>", "<span class=\"zh\">马上</span>"], a: 1, expl: "A stated date (六月七号) in front is only legal with **就要…了** — 快(要)…了 refuses a time word, the exam's favourite fine print. 马上 can't anchor to a calendar date this way, and 刚才 points backwards in time." },
        { q: "<span class=\"zh\">还好邻居___发现厨房着火，才没有引起大火。</span>", choices: ["<span class=\"zh\">及时</span>", "<span class=\"zh\">按时</span>", "<span class=\"zh\">准时</span>", "<span class=\"zh\">提前</span>"], a: 0, expl: "还好 ('luckily') + 才没有… = disaster narrowly avoided → 及时, 'before it was too late'. A fire is an emergency, not an appointment: 准时 needs an agreed clock time, 按时 needs a repeating schedule, and 提前 would absurdly mean the neighbor discovered the fire ahead of plan." },
      ]
    },

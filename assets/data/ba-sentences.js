...
In the sentence-ordering task, if you see a <span class="zh">把</span> tile: ① find the object noun → glue it right after 把; ② find the verb+complement chunk → glue it after the object; ③ everything modal/temporal/negative stacks in front. This solves it mechanically.</div>`
    ...
    /* ------------------------------------------------ 11 */
    {
      ...
      items: [
        ...
        { q: '<span class="zh">这次搬家___我累坏了。</span>', choices: ['<span class="zh">被</span>', '<span class="zh">把</span>', '<span class="zh">让</span>', '<span class="zh">对</span>'], a: 1, expl: "Event subject + 把 + person + result: 把我累坏了 'wore me out'. (让我累坏了 is also heard, but with 把 the result complement pattern is the standard exam answer here.)" },

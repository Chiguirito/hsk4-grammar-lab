...
<p class="zh" style="text-align:center;font-size:1.2rem">✗ 我把作业<b class="hl">做</b>。 &nbsp;&nbsp;→&nbsp;&nbsp; ✓ 我把作业<b class="hl">做完了</b>。</p>
      ...
      tabs: [
        {
          ...
          examples: [
            ...
            { cn: "她**把**自己的房间布置**成**了一个小花园。", py: "Tā bǎ zìjǐ de fángjiān bùzhì chéng le yí ge xiǎo huāyuán.", en: "She turned her room into a little garden.", note: "*给 alone often allows both orders (寄给他一封信 ✓), but 把 is required when the result matters: 把信寄给他." }
          ]
        },
        {
          label: "可以 optional",
...
“*<i>Lo</i> compré un libro” is impossible — <i>lo</i> must refer to a known thing. 把 objects follow exactly that logic: definite, identifiable, already on stage.</div>`
    ...
    /* ------------------------------------------------ 8 */
    {
      ...
      items: [
        ...
        { wrong: "请把这本词典还了给图书馆。", right: "请把这本词典还给图书馆。", py: "Qǐng bǎ zhè běn cídiǎn huán gěi túshūguǎn.", en: "Please return this dictionary to the library.", expl: "还给 is one welded unit — nothing, not even 了, may wedge between the verb and its 给-phrase. In a request like this you don't need 了 at all." },
        { wrong: "我把衣服都洗得很干净了在阳台上。", right: "我把衣服都洗干净，晾在阳台上了。", py: "Wǒ bǎ yīfu dōu xǐ gānjìng, liàng zài yángtái shàng le.", en: "I washed all the clothes and hung them on the balcony.", expl: "One 把-verb takes ONE ending. Two outcomes (clean + on the balcony) need two verb phrases. (晾 liàng = to hang out to dry.)" },
        ...
        { wrong: "妹妹都把冰箱里的酸奶喝光了。", right: "妹妹把冰箱里的酸奶都喝光了。", py: "Mèimei bǎ bīngxiāng li de suānnǎi dōu hē guāng le.", en: "My little sister drank up all the yogurt in the fridge.", expl: "都 quantifies the OBJECT (all the yogurt), so it sits after the 把-object, right before the verb. Placed before 把, 都 points at the subject instead — 妹妹都… reads as 'even my little sister', a different sentence entirely." },
      ]
    },
    ...
    /* ------------------------------------------------ consolidation */
    {
      ...
      items: [
        { tag: "进", cn: "出发前，记得**把**牙膏和毛巾放**进**背包里。", py: "Chūfā qián, jìde bǎ yágāo hé máojīn fàng jìn bēibāo li.", en: "Before you leave, remember to put the toothpaste and towel into your backpack.", note: "Two objects can share one **把** — and the ending **进背包里** still comes straight after the verb, as always." },
        { tag: "给", cn: "麻烦你下楼的时候，顺便**把**这个快递带**给**王阿姨。", py: "Máfan nǐ xià lóu de shíhou, shùnbiàn bǎ zhège kuàidì dài gěi Wáng āyí.", en: "When you go downstairs, could you take this package to Auntie Wang while you're at it?", note: "Everything polite (麻烦你…顺便) stacks in front of **把**; the receiver follows the verb as the **给** + person ending." },
        { tag: "成", cn: "爷爷**把**童年的回忆写**成**了一本书。", py: "Yéye bǎ tóngnián de huíyì xiě chéng le yì běn shū.", en: "Grandpa turned his childhood memories into a book.", note: "写**成** = written INTO a new form. The memories don't move anywhere — they change shape, so 成 is the right ending." },
        { tag: "起来", cn: "看到孙子哭了，奶奶马上**把**他抱**了起来**。", py: "Kàndào sūnzi kū le, nǎinai mǎshàng bǎ tā bào le qǐlái.", en: "Seeing her grandson crying, Grandma immediately picked him up.", note: "**抱起来** = directional complement as the ending; the adverb 马上 lives before 把, like all adverbs." },
        { tag: "result", cn: "请**把**这张申请表填写**清楚**，别忘了国籍那一项。", py: "Qǐng bǎ zhè zhāng shēnqǐngbiǎo tiánxiě qīngchu, bié wàng le guójí nà yí xiàng.", en: "Please fill out this application form clearly — don't forget the nationality field.", note: "填写**清楚** = result complement: filled in so it's clear and complete. 请 + 把 is the classic polite instruction frame." },
      ]
    },
    ...
    /* ------------------------------------------------ 9 */
    {
      ...
      items: [
        ...
        { tiles: ["他", "把", "那些", "旧衣服", "都", "送给", "别人", "了"], py: "Tā bǎ nàxiē jiù yīfu dōu sònggěi biérén le.", en: "He gave all those old clothes away to others.", hint: "都 comes after the object, before the verb.", alt: [["他", "把", "那些", "旧衣服", "都", "送给", "了", "别人"]] },
        { tiles: ["我", "已经", "把", "会议时间", "通知", "大家", "了"], py: "Wǒ yǐjīng bǎ huìyì shíjiān tōngzhī dàjiā le.", en: "I've already notified everyone of the meeting time.", hint: "已经 before 把; 通知 + person as ending.", alt: [["我", "已经", "把", "会议时间", "通知", "了", "大家"]] },
...
In the sentence-ordering task, if you see a <span class="zh">把</span> tile: ① find the object noun → glue it right after 把; ② find the verb+complement chunk → glue it after the object; ③ everything modal/temporal/negative stacks in front. This solves it mechanically.</div>`
    ...
    /* ------------------------------------------------ 11 */
    {
      ...
      short: "Final drill",
      intro: "Questions at (or slightly above) real exam difficulty. Aim for at least 80%.",
      items: [
        ...
        { q: "Which sentence is WRONG?", choices: ["<span class=\"zh\">妈妈把酸奶放进冰箱里了。</span>", "<span class=\"zh\">我把老师的电话号码记下来了。</span>", "<span class=\"zh\">他把我说的话怀疑了。</span>", "<span class=\"zh\">哥哥把鞋擦得亮亮的。</span>"], a: 2, expl: "怀疑 is an attitude in your head — the words aren't handled or changed, so 把 refuses it (same family as 知道、觉得、喜欢). Say 他怀疑我说的话。 The other three all handle their object and end properly: 进 + place, directional 下来, and 得 + description." },
      ]
    },

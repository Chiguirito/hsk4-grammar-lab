...
Listening loves 什么都没… (did he eat or not?); reading loves 谁都/哪儿都 as quiet “everyone/everywhere”; writing loves arranging 想去哪儿就去哪儿. You'll meet all four jobs on one exam paper.</div>`
    ...
    /* ------------------------------------------------ 3 */
    {
      ...
      items: [
        ...
        { tag: "anyone", cn: "这种手机**哪儿都**买得到，别担心。", py: "Zhè zhǒng shǒujī nǎr dōu mǎi de dào, bié dānxīn.", en: "You can buy this kind of phone anywhere — don't worry.", note: "哪儿都 + potential complement 买得到: available everywhere." },
...
<p>Note the 吗! With 吗 (or 想不想), the sentence asks IF you want something. Without 吗, 你想喝什么？ asks WHAT you want. One little particle flips the job of 什么.</p>`,
    ...
    /* ------------------------------------------------ 8 */
    {
      ...
      items: [
        { tiles: ["这件事", "谁", "都", "知道"], py: "Zhè jiàn shì shéi dōu zhīdào.", en: "Everyone knows about this.", hint: "Topic + 谁都 + verb." },
        { tiles: ["他", "今天", "什么", "都", "不想", "吃"], py: "Tā jīntiān shénme dōu bù xiǎng chī.", en: "He doesn't feel like eating anything today.", hint: "QW + 都 + negation + verb." },
        { tiles: ["周末", "我", "哪儿", "也", "不想去"], py: "Zhōumò wǒ nǎr yě bù xiǎng qù.", en: "On the weekend I don't want to go anywhere.", hint: "Negative prefers 也 — subject before the QW-phrase." },
...
Arrangement task with a duplicated question word tile (two 什么, two 哪儿…)? That's ALWAYS the whatever-pattern: build V1 + QW + 就 + V2 + QW. And if you see 都/也 next to a single QW tile, snap them together before anything else.</div>`
    ...
    /* ------------------------------------------------ 11 */
    {
      ...
      short: "Final drill",
      intro: "Twelve questions across all four jobs. Distractors are the errors from the clinic — see if they still fool you. Aim for 10+.",
      items: [

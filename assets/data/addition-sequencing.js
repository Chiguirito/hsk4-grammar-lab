...
<span class="zh">既…又</span> = “both…and”. <span class="zh">既然…就</span> = “since (that's the case)… then” — a cause-effect pattern from the 因果 topic. Seeing 既然? Think <i>reason</i>, not <i>list</i>.</div>`
    ...
    /* ------------------------------------------------ 8 */
    {
      ...
      items: [
        ...
        { wrong: "厨师一方面做菜，另一方面给客人介绍今天的小吃。", right: "厨师一边做菜，一边给客人介绍今天的小吃。", py: "Chúshī yìbiān zuò cài, yìbiān gěi kèrén jièshào jīntiān de xiǎochī.", en: "The chef introduces today's snacks to the guests while he cooks.", expl: "做菜 and 介绍 are two simultaneous physical ACTIONS → 一边…一边. 一方面…另一方面 lines up abstract aspects or reasons in an argument — it can't hold things you do with your hands at the same moment." },
      ]
    },
...
In the ordering task, pair-words are magnets: find 不但 → look for the tile with 而且/还/也; find 先 → hunt for 再/然后/最后. Place the pair skeleton first, then hang subjects and objects onto it.</div>`
    ...
    /* ------------------------------------------------ 11 */
    {
      ...
      items: [
        ...
        { q: "Choose the correct sentence:", choices: ["<span class=\"zh\">爸爸不但同情这只可怜的小猫，妈妈也想把它带回家。</span>", "<span class=\"zh\">不但爸爸同情这只可怜的小猫，妈妈也想把它带回家。</span>", "<span class=\"zh\">不但爸爸同情这只可怜的小猫，也妈妈想把它带回家。</span>", "<span class=\"zh\">爸爸同情不但这只可怜的小猫，妈妈也想把它带回家。</span>"], a: 1, expl: "Two different subjects (爸爸 / 妈妈) → the subject test says 不但 jumps in FRONT of the first subject: 不但爸爸…，妈妈也…. Keeping 不但 after 爸爸 pretends one subject does both things; and 也 is an adverb — it follows 妈妈, never stands before her." },
        { q: "<span class=\"zh\">价格降低以后，这种手机不但没有卖得更好，___卖得更差了。</span>", choices: ["<span class=\"zh\">而且</span>", "<span class=\"zh\">反而</span>", "<span class=\"zh\">然后</span>", "<span class=\"zh\">所以</span>"], a: 1, expl: "The first half is negative (不但**没有**…), so the outcome runs OPPOSITE to expectation → **反而**. 而且 only escalates in the SAME direction and needs a positive first half; 然后 sequences events; 所以 draws a conclusion — neither flips the direction." },
      ]
    },

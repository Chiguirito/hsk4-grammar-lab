...
<span class="zh">既…又</span> = “both…and”. <span class="zh">既然…就</span> = “since (that's the case)… then” — a cause-effect pattern from the 因果 topic. Seeing 既然? Think <i>reason</i>, not <i>list</i>.</div>`
    ...
    /* ------------------------------------------------ 8 */
    {
      ...
      items: [
        ...
        { wrong: "上个周末我们先参观了博物馆，再去了一家四川饭馆。", right: "上个周末我们先参观了博物馆，然后去了一家四川饭馆。", py: "Shàng gè zhōumò wǒmen xiān cānguān le bówùguǎn, ránhòu qù le yì jiā Sìchuān fànguǎn.", en: "Last weekend we first visited the museum, then went to a Sichuan restaurant.", expl: "再 chains future/planned steps only. Completed past events take 然后 or 接着." },
        { wrong: "这个房间既干净又非常大。", right: "这个房间既干净又明亮。", py: "Zhège fángjiān jì gānjìng yòu míngliàng.", en: "This room is both clean and bright.", expl: "既…又 demands balance: two bare adjectives of similar weight. 非常 overloads the second side — degree adverbs don't fit inside the pair." },
    ...
    /* ------------------------------------------------ 9 */
    {
      ...
      items: [
        ...
        { tiles: ["这儿的冬天", "又", "冷", "又", "干燥"], py: "Zhèr de dōngtiān yòu lěng yòu gānzào.", en: "Winters here are cold and dry.", hint: "Two qualities, colloquial — the 又…又 sandwich." },
        { tiles: ["我们", "一边", "喝咖啡", "一边", "讨论计划"], py: "Wǒmen yìbiān hē kāfēi, yìbiān tǎolùn jìhuà.", en: "We discussed the plan over coffee.", hint: "Two simultaneous actions — each 一边 grabs one verb phrase." },
        ...
        { tiles: ["学游泳", "一方面", "能锻炼身体", "另一方面", "也", "很有意思"], py: "Xué yóuyǒng yì fāngmiàn néng duànliàn shēntǐ, lìng yì fāngmiàn yě hěn yǒu yìsi.", en: "Learning to swim exercises your body on one hand, and is good fun on the other.", hint: "Two aspects of one topic; 也 helps half two." },
...
In the ordering task, pair-words are magnets: find 不但 → look for the tile with 而且/还/也; find 先 → hunt for 再/然后/最后. Place the pair skeleton first, then hang subjects and objects onto it.</div>`
    ...
    /* ------------------------------------------------ 11 */
    {
      ...
      items: [
        ...
        { q: 'Choose the correct sentence:', choices: ['<span class="zh">他不但没来，连电话也没打。</span>', '<span class="zh">不但他没来，连电话也没打。</span>', '<span class="zh">他没来不但，连电话也没打。</span>', '<span class="zh">不但没来他，连电话也没打。</span>'], a: 0, expl: "Same subject 他 does both (not coming, not calling) → 他不但…. Option B pretends a second subject is coming." },

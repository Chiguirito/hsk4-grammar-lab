...
<p>The consequence can be a verb phrase, a negative clause, even a small sentence. This is the pattern behind half the emotional sentences in HSK 4 reading texts.</p>`,
    ...
    /* ------------------------------------------------ 7 */
    {
      ...
      items: [
        ...
        { wrong: "今天早上我起了得很晚，差点儿错过了火车。", right: "今天早上我起得很晚，差点儿错过了火车。", py: "Jīntiān zǎoshang wǒ qǐ de hěn wǎn, chàdiǎnr cuòguò le huǒchē.", en: "I got up really late this morning and almost missed the train.", expl: "得 must touch the BARE verb — aspect 了 can never squeeze in between: ✗起了得很晚. The state complement itself already delivers the after-the-fact verdict; past time comes from context (今天早上), not from a 了 on the verb." },
      ]
    },
...
See a <span class="zh">得</span> tile in the ordering task? First find the verb it belongs to (V得 is usually one tile or two adjacent ones), then ask: is the rest an evaluation (→ after 得) or an object (→ before the verb, possibly forcing a verb copy)? That decision solves the item.</div>`
    ...
    /* ------------------------------------------------ 10 */
    {
      ...
      items: [
        ...
        { q: "How do you ask “How did he do on the HSK exam?”", choices: ['<span class="zh">他考得怎么样？</span>', '<span class="zh">他考试得怎么样？</span>', '<span class="zh">他怎么样考得？</span>', '<span class="zh">他考得吗？</span>'], a: 0, expl: "Question word sits in the description slot: 考得 + 怎么样. In ✗他考试得怎么样 the object 试 blocks 得 from the verb (you'd need 考试考得怎么样)." },
        ...
        { q: "<span class=\"zh\">获得了这个月的奖金，他高兴___。</span>", choices: ["<span class=\"zh\">极了</span>", "<span class=\"zh\">得极了</span>", "<span class=\"zh\">透了</span>", "<span class=\"zh\">很极了</span>"], a: 0, expl: "极了 glues DIRECTLY onto the adjective — the 得 bridge belongs to 得很/得要命/得不得了, so ✗高兴得极了. 透了 only amplifies negative feelings (糟透了), and ✗很极了 stacks two intensities, which is never allowed." },
        { q: "<span class=\"zh\">你放心，他办事___，不会有问题。</span>", choices: ["<span class=\"zh\">细心得很</span>", "<span class=\"zh\">得很细心</span>", "<span class=\"zh\">很细心得很</span>", "<span class=\"zh\">细心极</span>"], a: 0, expl: "办事 is verb + object, so 得 may not follow it directly — ✗办事得很细心 (you'd have to copy the verb: 办事办得很细心). The topic-comment layout 办事 + 细心**得很** works perfectly: Adj + 得很. ✗很细心得很 double-intensifies; ✗细心极 is incomplete — 极 needs 了." },
      ]
    },

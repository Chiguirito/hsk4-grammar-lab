...
A question word and 吗 can't share one sentence: ✗<span class="zh">你是什么时候来的吗？</span> Pick one engine per question.</div>`
    ...
    /* ------------------------------------------------ 8 */
    {
      ...
      items: [
        { tiles: ["他", "是", "去年", "来", "中国", "的"], py: "Tā shì qùnián lái Zhōngguó de.", en: "It was last year that he came to China.", hint: "Time spotlight straight after 是." },
        ...
        { tiles: ["你", "是", "怎么", "知道", "这件事", "的"], py: "Nǐ shì zěnme zhīdào zhè jiàn shì de?", en: "How did you find out about this?", hint: "Question word sits in the spotlight slot." },
        { tiles: ["我", "不是", "故意", "迟到", "的"], py: "Wǒ bú shì gùyì chídào de.", en: "I wasn't late on purpose.", hint: "Negative cleft: 不是 stays welded." },
        { tiles: ["我", "是", "在网上", "认识", "的", "他"], py: "Wǒ shì zài wǎngshàng rènshi de tā.", en: "I met him online.", hint: "The object may follow 的 — colloquial and exam-approved." },
...
<p>Without 的, <span class="zh">他会来</span> is a cool prediction. With it — <span class="zh">他会来<b class="hl">的</b></span> — you're patting someone's shoulder. This is why doctors, parents and best friends end every sentence with 的.</p>`,
          examples: [
            ...
            { cn: "只要你每天练习，你的发音会越来越好**的**。", py: "Zhǐyào nǐ měitiān liànxí, nǐ de fāyīn huì yuè lái yuè hǎo de.", en: "As long as you practice daily, your pronunciation will get better and better.", note: "How to tell it apart from 是…的: the event is FUTURE and there's a 会. Different machine, same 的." }
          ]
        }
      ]
    },

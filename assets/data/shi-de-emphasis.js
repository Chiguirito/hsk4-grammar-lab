...
A question word and 吗 can't share one sentence: ✗<span class="zh">你是什么时候来的吗？</span> Pick one engine per question.</div>`
    ...
    /* ------------------------------------------------ 7 */
    {
      ...
      items: [
        ...
        { wrong: "这份资料是王律师帮我们准备。", right: "这份资料是王律师帮我们准备的。", py: "Zhè fèn zīliào shì Wáng lǜshī bāng wǒmen zhǔnbèi de.", en: "These materials were prepared for us by Lawyer Wang.", expl: "是 opened a doer spotlight but nothing closed it — the cleft is a two-part frame. In casual speech 是 may drop; the sentence-final 的 never does." },
      ]
    },
    ...
    /* ------------------------------------------------ consolidation */
    {
      ...
      items: [
        { tag: "time", cn: "你们的飞机**是**几点降落**的**？——八点半，我们**是**在上海转机**的**，所以晚了一点儿。", py: "Nǐmen de fēijī shì jǐ diǎn jiàngluò de? —— Bā diǎn bàn, wǒmen shì zài Shànghǎi zhuǎnjī de, suǒyǐ wǎn le yìdiǎnr.", en: "What time did your plane land? — Eight thirty. We changed planes in Shanghai, so we got in a bit late.", note: "The landing is known — 是几点…的 asks for the time detail, and the reply reuses the frame to spotlight 在上海." },
        { tag: "manner", cn: "打车去机场太贵了，我们**是**坐大巴去**的**。", py: "Dǎchē qù jīchǎng tài guì le, wǒmen shì zuò dàbā qù de.", en: "A taxi to the airport is too expensive — we went by coach.", note: "Manner spotlight: the trip itself is old news, HOW you went is the point. 大巴 = long-distance coach / shuttle bus." },
        { tag: "manner", cn: "你做菜做得这么好吃，**是**跟谁学**的**？——**是**看视频自学**的**。", py: "Nǐ zuò cài zuò de zhème hǎochī, shì gēn shéi xué de? —— Shì kàn shìpín zìxué de.", en: "Your cooking is amazing — who did you learn from? — I taught myself from videos.", note: "跟谁 asks for a teacher; the answer swaps in a manner spotlight (看视频自学). The subject drops freely in replies." },
        { tag: "object", cn: "我**是**在南京读**的**本科，研究生**是**在北京读**的**。", py: "Wǒ shì zài Nánjīng dú de běnkē, yánjiūshēng shì zài Běijīng dú de.", en: "I did my bachelor's in Nanjing; my master's I did in Beijing.", note: "Object 本科 slips in AFTER 的 (读的本科); in the second half 研究生 fronts as the topic — both legal homes for the object." },
        { tag: "modal 的", cn: "放心吧，你的同学都很热情，你不会觉得孤单**的**。", py: "Fàngxīn ba, nǐ de tóngxué dōu hěn rèqíng, nǐ bú huì juéde gūdān de.", en: "Don't worry — your classmates are really friendly; you won't feel lonely.", note: "Modal 的: 不会…的 = warm reassurance about the FUTURE. No 是, no past event — a different 的-machine from the cleft." },
      ]
    },
...
Word-arrangement task: a 是 tile + a sentence-final 的 tile + a past-time word = build a cleft. Glue 是 + time/place/manner first, verb next, 的 last. If you also see 会, it's the promise machine instead — no spotlight needed.</div>`
    ...
    /* ------------------------------------------------ 11 */
    {
      ...
      short: "Final drill",
      intro: "A mixed drill on all three machines — clefts, 并, 难道, plus the reassuring 的. Aim for four out of five or better.",
      items: [
        { q: '<span class="zh">A：好久不见！你什么时候回国的？ B：我___。</span>', choices: ['<span class="zh">是上个月回来的</span>', '<span class="zh">上个月回来了的</span>', '<span class="zh">是上个月回来了</span>', '<span class="zh">回来是上个月的</span>'], a: 0, expl: "Echo the cleft: 是 + 上个月 (spotlight) + 回来 + 的. The versions with 了 double-mark the past; ✗回来是上个月的 strands the spotlight outside the frame." },
        ...
        { q: "Which sentence is correct?", choices: ["<span class=\"zh\">这台打印机是小王修理的。</span>", "<span class=\"zh\">这台打印机是小王修理了。</span>", "<span class=\"zh\">这台打印机小王是修理的。</span>", "<span class=\"zh\">这台打印机是小王修理的了。</span>"], a: 0, expl: "Doer spotlight: topic (这台打印机) + 是 + 小王 + verb + 的. B closes the cleft with 了 — the wrong machine; D stacks 的+了, which never combine; C strands the doer outside the frame — 是 must stand directly before the spotlight." },
        { q: "<span class=\"zh\">体检结果都出来了，医生也让你少喝酒，___你还想每天喝白酒吗？</span>", choices: ["<span class=\"zh\">难道</span>", "<span class=\"zh\">并</span>", "<span class=\"zh\">是不是</span>", "<span class=\"zh\">到底</span>"], a: 0, expl: "Rhetorical disbelief ending in 吗, dialed up by 还 → 难道…吗: 'you can't SERIOUSLY still want to drink baijiu every day?!' 并 must sit directly on 不/没; 是不是 can't share a sentence with 吗; 到底 presses for a real answer, but the speaker already knows it — and like 是不是, 到底 refuses to share a sentence with 吗: it needs a question word or an A-not-A form (你到底想不想戒酒？)." },
      ]
    },

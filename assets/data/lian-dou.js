...
In <span class="zh">连他都会</span>, 都 doesn't mean “all” — 他 is one person! After 连 (or after 一+M), 都 is pure emphasis glue. Don't translate it; just check it's there.</div>`
    ...
    /* ------------------------------------------------ 6 */
    {
      ...
      items: [
        { q: '“He doesn\'t even drink tea.” Which is correct?', choices: ['他连不喝茶。', '他连茶都不喝。', '他连都不喝茶。', '他不喝连茶都。'], a: 1, expl: "连 grabs the extreme object (茶), the pair moves before the verb, 都 closes the clamp: 连茶都不喝. Without 都/也 the pattern collapses (option A)." },
        ...
        { q: 'Which sentence means “She left without even saying goodbye”?', choices: ['她连说再见都没有就走了。', '她连再见都没说就走了。', '她没连说再见都就走了。', '她连没说再见都就走了。'], a: 1, expl: "连 + object (再见) + 都 + 没 + verb (说): 连再见都没说. Negation lives after 都, and the verb keeps its place." },
        { q: '<span class="zh">我一点儿___不饿，你自己吃吧。</span>', choices: ['<span class="zh">也</span>', '<span class="zh">还</span>', '<span class="zh">很</span>', '<span class="zh">too many options</span>'], a: 0, expl: "一点儿也不 + adjective = 'not even a little'. It's the little sister of 连…都: the extreme amount 一点儿 + the clamp 也 + negation." },
...
Word-arrangement: see a 连 tile? Find the extreme case (noun/verb/一+M) to glue after it, find 都/也 to close the clamp, park negation after the clamp, verb last. The sentence assembles itself.</div>`
    ...
    /* ------------------------------------------------ 11 */
    {
      ...
      items: [
        ...
        { q: '<span class="zh">A：你借他钱了吗？ B：我自己___，怎么借给他？</span>', choices: ['<span class="zh">连一分钱都没有</span>', '<span class="zh">一分钱连没有</span>', '<span class="zh">连一分钱没有</span>', '<span class="zh">都一分钱没有</span>'], a: 0, expl: "连一分钱都没有 — the full clamp. C is the tempting one: dropping 都 is illegal (you may only drop 连, never 都)." },

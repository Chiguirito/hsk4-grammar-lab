...
In the ordering task, a lone tile like 面/觉/澡/假/泳 is a flashing sign: it's the object half of a 离合词. Find its verb half, then slot 了/过/duration/次数 between them — the sentence solves itself.</div>`
    ...
    /* ------------------------------------------------ 11 */
    {
      ...
      items: [
        ...
        { q: 'Which sentence is WRONG?', choices: ['<span class="zh">我去排个队，你去买饮料。</span>', '<span class="zh">我们排了半个小时队。</span>', '<span class="zh">我们排队了半个小时。</span>', '<span class="zh">前面排队的人太多了。</span>'], a: 2, expl: "Duration must go inside: 排了半个小时队. Option C glues the compound shut and dumps the duration behind — the classic error." },

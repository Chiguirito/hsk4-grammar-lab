...
The fill-the-blank section almost always contains one 又/再/还 slot, and the three wrong options are… the other two plus 也. If you can date-stamp the event, you get a free point.</div>`
    ...
    /* ------------------------------------------------ 3 */
    {
      ...
      items: [
        ...
        { tag: "又·add", cn: "他点了一个鱼，**又**点了一个汤。", py: "Tā diǎn le yí gè yú, yòu diǎn le yí gè tāng.", en: "He ordered a fish, and then ordered a soup as well.", note: "又 can stack completed actions: did A, then also did B — both already stamped." },
...
Blank before a verb? Ask in order: ① Already happened (or calendar-certain)? → <b>又</b>. ② Not happened yet / request / “then”? → <b>再</b>. ③ Nothing new — old state dragging on, or adding to a list? → <b>还</b>.</div>`
    ...
    /* ------------------------------------------------ 9 */
    {
      ...
      items: [
        ...
        { tiles: ["他", "今天", "又", "忘了", "带", "作业"], py: "Tā jīntiān yòu wàng le dài zuòyè.", en: "He forgot to bring his homework again today.", hint: "Already happened → 又 before the verb." },

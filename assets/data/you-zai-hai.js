...
Blank before a verb? Ask in order: ① Already happened (or calendar-certain)? → <b>又</b>. ② Not happened yet / request / “then”? → <b>再</b>. ③ Nothing new — old state dragging on, or adding to a list? → <b>还</b>.</div>`
    ...
    /* ------------------------------------------------ 8 */
    {
      ...
      items: [
        ...
        { wrong: "这首歌真好听，还唱一遍吧！", right: "这首歌真好听，再唱一遍吧！", py: "Zhè shǒu gē zhēn hǎotīng, zài chàng yí biàn ba!", en: "This song is so beautiful — sing it one more time!", expl: "A 吧-request for one counted repeat (一遍) → 再 + V + 一遍, the same slot as 请再说一遍. 还 can front a plain future verb (明天还来), but it can't order up a measured extra round — to use it here you'd climb before a modal: 我还想听一遍 ✓." },
      ]
    },
    ...
    /* ------------------------------------------------ consolidation */
    {
      ...
      items: [
        { tag: "又", cn: "办公室的打印机**又**坏了，上星期才修理过。", py: "Bàngōngshì de dǎyìnjī yòu huài le, shàng xīngqī cái xiūlǐ guo.", en: "The office printer has broken down again — it was only repaired last week.", note: "Realized repeat → **又** + V + 了. 上星期才修理过 supplies round one; today's breakdown is round two, already stamped." },
        { tag: "先…再", cn: "这个问题我得先查一下资料，**再**给你详细的回复。", py: "Zhège wèntí wǒ děi xiān chá yíxià zīliào, zài gěi nǐ xiángxì de huífù.", en: "I'll need to look up some information on this first, and then I'll get back to you with a detailed answer.", note: "先 A **再** B — the reply waits its turn in the future, so it files under 再. This 再 = 'then', no repetition anywhere." },
        { tag: "还", cn: "都晚上十点了，体育馆里**还**有人在打羽毛球。", py: "Dōu wǎnshang shí diǎn le, tǐyùguǎn li hái yǒu rén zài dǎ yǔmáoqiú.", en: "It's already ten at night and there are still people playing badminton in the gym.", note: "都…了 sets the expected end; **还** says the activity ran right past it. 还有人在 + V = there are still people V-ing." },
        { tag: "又要…了", cn: "明天**又**要降温了，最低温度只有两摄氏度。", py: "Míngtiān yòu yào jiàngwēn le, zuìdī wēndù zhǐyǒu liǎng Shèshìdù.", en: "It's turning colder again tomorrow — the low will be just two degrees Celsius.", note: "Future, but forecast-certain: another round of the weather cycle is pre-stamped, so it takes **又**要…了, not 再." },
        { tag: "再+adj", cn: "售货员说，这种皮鞋要是买两双，还能**再**便宜一点儿。", py: "Shòuhuòyuán shuō, zhè zhǒng píxié yàoshi mǎi liǎng shuāng, hái néng zài piányi yìdiǎnr.", en: "The salesclerk said that if you buy two pairs of these leather shoes, the price can come down a bit more.", note: "**再** + adj + 一点儿 = a further future decrease — bargaining 再. Note the stack: 还 (additionally) sits before 能, 再 after it." },
      ]
    },
...
When MCQ options include 也, remember: 也 compares two DIFFERENT subjects doing the same thing (他去，我也去). 又/再/还 keep the SAME subject repeating or continuing. Different axis entirely.</div>`
    ...
    /* ------------------------------------------------ 11 */
    {
      ...
      short: "Final drill",
      intro: "Blanks and bug-hunts at exam difficulty. The wrong options are the exact confusions this page just cured — prove they're gone.",
      items: [
        ...
        { q: "<span class=\"zh\">现在餐厅里人太多了，我们过半个小时___来吧。</span>", choices: ["<span class=\"zh\">又</span>", "<span class=\"zh\">再</span>", "<span class=\"zh\">还</span>", "<span class=\"zh\">才</span>"], a: 1, expl: "吧 marks a suggestion, so the coming-back is still ahead → (过半个小时)**再** + V, the same postpone frame as 以后再谈. 又来 would stamp the return as already done; 还来 would frame the visit as a continuing pattern (下次还来啊!) rather than this one-off postponed return; 才来 factually reports a late arrival and can't live inside a 吧-suggestion." },
        { q: "<span class=\"zh\">下星期公司___要组织体检了，一年过得真快。</span>", choices: ["<span class=\"zh\">再</span>", "<span class=\"zh\">又</span>", "<span class=\"zh\">还</span>", "<span class=\"zh\">才</span>"], a: 1, expl: "The annual checkup is scheduled and cyclical — the calendar already stamped it, so even a future event takes **又**要…了. 再要 hands a done-deal calendar event to the not-yet word; 还要 would mean 'additionally wants'; 才要…了 collides head-on — 'not-until' 才 can't share a clause with the already-sealed …了." },
      ]
    },

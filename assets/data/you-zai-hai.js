...
Blank before a verb? Ask in order: ① Already happened (or calendar-certain)? → <b>又</b>. ② Not happened yet / request / “then”? → <b>再</b>. ③ Nothing new — old state dragging on, or adding to a list? → <b>还</b>.</div>`
    ...
    /* ------------------------------------------------ 8 */
    {
      ...
      items: [
        ...
        { wrong: "冰箱里的汽水喝完了，妈妈说周末还去买。", right: "冰箱里的汽水喝完了，妈妈说周末再去买。", py: "Bīngxiāng li de qìshuǐ hē wán le, māma shuō zhōumò zài qù mǎi.", en: "The soda in the fridge is all gone — Mom says she'll buy more this weekend.", expl: "周末 parks the shopping trip in the future, and before the bare verb 去 that slot belongs to 再 — the same postpone frame as 以后再谈. To add the errand with 还, you need a modal: 周末还要去买 ✓, 还去买 ✗." },
      ]
    },
...
When MCQ options include 也, remember: 也 compares two DIFFERENT subjects doing the same thing (他去，我也去). 又/再/还 keep the SAME subject repeating or continuing. Different axis entirely.</div>`
    ...
    /* ------------------------------------------------ 11 */
    {
      ...
      items: [
        ...
        { q: "<span class=\"zh\">现在餐厅里人太多了，我们过半个小时___来吧。</span>", choices: ["<span class=\"zh\">又</span>", "<span class=\"zh\">再</span>", "<span class=\"zh\">还</span>", "<span class=\"zh\">才</span>"], a: 1, expl: "吧 marks a suggestion, so the coming-back is still ahead → (过半个小时)**再** + V, the same postpone frame as 以后再谈. 又来 would stamp the return as already done; 还来 claims a state that never stopped; 才来 factually reports a late arrival and can't live inside a 吧-suggestion." },

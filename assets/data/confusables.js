...
Don't read the passage first. Read the WORD BANK, tag each word's POS and its two favourite collocations, and only then scan the blanks. You'll place half the words before "reading" at all.</div>`
    ...
    /* ------------------------------------------------ 8 */
    {
      ...
      items: [
        ...
        { wrong: "旅行之前，我们要先肯定一下宾馆的位置。", right: "旅行之前，我们要先确定一下宾馆的位置。", py: "Lǚxíng zhīqián, wǒmen yào xiān quèdìng yíxià bīnguǎn de wèizhì.", en: "Before the trip, we should first confirm the hotel's location.", expl: "Pinning down a concrete detail (a time, a place, a location) is 确定's job. Verb 肯定 means to affirm/praise (老师肯定了我们的努力), and adverb 肯定 makes a confident guess — neither can fix a hotel's location." },
      ]
    },

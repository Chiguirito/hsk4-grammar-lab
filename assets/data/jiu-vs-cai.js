...
In the error-spotting and word-arrangement tasks, <span class="zh">才…了</span> at the end of a sentence is a planted bug about 80% of the time. See 才 + final 了? Sound the alarm.</div>`
    ...
    /* ------------------------------------------------ 8 */
    {
      ...
      items: [
        ...
        { wrong: "只要你把资料准备好，才能去应聘。", right: "只要你把资料准备好，就能去应聘。", py: "Zhǐyào nǐ bǎ zīliào zhǔnbèi hǎo, jiù néng qù yìngpìn.", en: "As long as you get your documents ready, you can go apply for the job.", expl: "只要 announces an easy-to-meet condition, and its welded partner is **就**. 才 belongs to 只有, the strict-condition marker. The word at the front decides the pairing — swap 只要 for 只有 and 才 would win instead." },
      ]
    },
    ...
    /* ------------------------------------------------ consolidation */
    {
      ...
      items: [
        { tag: "time·早", cn: "导游说八点在酒店门口集合，他七点半**就**下楼等着了。", py: "Dǎoyóu shuō bā diǎn zài jiǔdiàn ménkǒu jíhé, tā qī diǎn bàn jiù xià lóu děngzhe le.", en: "The guide said to meet at the hotel entrance at eight — he was already downstairs waiting by half past seven.", note: "Half an hour earlier than required → **就**, and the cheerful final 了 tags along. Seating chart: subject + time + 就 + verb." },
        { tag: "amount·少", cn: "新家距离地铁站特别近，走三分钟**就**到了。", py: "Xīn jiā jùlí dìtiězhàn tèbié jìn, zǒu sān fēnzhōng jiù dào le.", en: "The new apartment is really close to the subway station — a three-minute walk and you're there.", note: "Small amount (三分钟) before the result → **就**…了. Swap in 才 and the same walk suddenly sounds like a trek." },
        { tag: "一…就", cn: "他**一**听说老同学获奖，**就**打电话去祝贺。", py: "Tā yì tīngshuō lǎo tóngxué huòjiǎng, jiù dǎ diànhuà qù zhùhè.", en: "The moment he heard his old classmate had won an award, he phoned to congratulate him.", note: "一 A **就** B: hearing the news and dialing happen with zero gap. The welded pair never accepts 才 in the 就 seat." },
        { tag: "effort·多", cn: "办公室的打印机坏了，师傅修了两个多小时**才**修好。", py: "Bàngōngshì de dǎyìnjī huài le, shīfu xiū le liǎng ge duō xiǎoshí cái xiū hǎo.", en: "The office printer broke down, and it took the repairman over two hours to get it working again.", note: "Big effort (修了两个多小时) before success → **才**. That 了 belongs to 修了…小时 — and no final 了 after 修好, per the 了-rule." },
        { tag: "才+就", cn: "这个小伙子**才**工作了两年，**就**当上负责人了。", py: "Zhège xiǎohuǒzi cái gōngzuò le liǎng nián, jiù dāngshàng fùzérén le.", en: "This young guy has only been working for two years, and he's already the one in charge.", note: "The contrast machine: **才** shrinks the input (a mere two years), **就** inflates the output (already the boss). Star HSK frame." },
      ]
    },
...
In the listening section, 就 and 才 are often the ONLY difference between “the man is impressed” and “the man is annoyed”. Train your ear to catch the single syllable after the time word — it usually IS the answer.</div>`
    ...
    /* ------------------------------------------------ 11 */
    {
      ...
      short: "Final drill",
      intro: "Real exam difficulty. The distractors are the mistakes your classmates actually make. Aim for at least four out of five.",
      items: [
        ...
        { q: '<span class="zh">妈妈说，只要先写完作业，___可以看电视。</span>', choices: ['<span class="zh">就</span>', '<span class="zh">才</span>', '<span class="zh">再</span>', '<span class="zh">都</span>'], a: 0, expl: "只要 ('as long as') marks an easy-to-meet condition, and its welded partner is 就. Swap in 只有 and the answer flips to 才 (compare the HSK-certificate question in this drill) — the marker word decides, not the homework. Without either marker, both 就 and 才 would be sayable; the exam plants the marker precisely to force the choice." },
        { q: "<span class=\"zh\">这位著名的律师特别忙，我等了两个星期___见到他。</span>", choices: ["<span class=\"zh\">就</span>", "<span class=\"zh\">才</span>", "<span class=\"zh\">刚</span>", "<span class=\"zh\">再</span>"], a: 1, expl: "A two-week wait is more than anyone hopes for → **才**. 就 would boast the wait was short; 刚 neutrally reports 'just recently' with zero attitude; 再 needs a future 'then/again' frame. Extra clue: no 了 after 见到他 — the 了-rule in action." },
        { q: "<span class=\"zh\">你得先本科毕业，___能报考研究生。</span>", choices: ["<span class=\"zh\">才</span>", "<span class=\"zh\">就</span>", "<span class=\"zh\">再</span>", "<span class=\"zh\">又</span>"], a: 0, expl: "得先… states a requirement that must be met first, so the result clause takes **才**能 — 'only then can you'. 就 would erase the barrier (就 partners with easy conditions like 只要); 先…再 is a real pair but 再 can't sit before 能 and lacks the 'only then possible' meaning; 又 marks a repeated past event." },
      ]
    },

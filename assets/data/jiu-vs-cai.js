...
就/才 questions test whether you read the <b>speaker's attitude</b>, not just the clock. Listening dialogues ask “What does the woman think?” — and the whole answer hangs on one syllable.</div>`
    ...
    /* ------------------------------------------------ 2 */
    {
      ...
      rows: [
        ...
        ['<b>Quantity / effort</b>', '<span class="zh">这篇作文他一个小时<b class="hl">就</b>写完了。</span> <span class="py-hint">Zhè piān zuòwén tā yí gè xiǎoshí jiù xiě wán le.</span> Only one hour — fast!', '<span class="zh">他写了三个小时<b class="hl">才</b>写完。</span> <span class="py-hint">Tā xiě le sān gè xiǎoshí cái xiě wán.</span> Took three whole hours.'],
        ...
        ['<b>“Only” flavor</b>', '<span class="zh"><b class="hl">就</b>他一个人知道。</span> <span class="py-hint">Jiù tā yí gè rén zhīdào.</span> Precisely him, no one else.', '<span class="zh">这本书<b class="hl">才</b>五块钱。</span> <span class="py-hint">Zhè běn shū cái wǔ kuài qián.</span> A mere five kuai — surprisingly little.']
      ]
    },
    ...
    /* ------------------------------------------------ 3 */
    {
      ...
      items: [
        ...
        { tag: "就=only", cn: "别问别人了，**就**他一个人知道密码。", py: "Bié wèn biérén le, jiù tā yí gè rén zhīdào mìmǎ.", en: "Don't bother asking anyone else — he's the only one who knows the password.", note: "就 + noun = 'precisely / only'. Here 就 sits BEFORE the subject — different job, different position." },
...
In the error-spotting and word-arrangement tasks, <span class="zh">才…了</span> at the end of a sentence is a planted bug about 80% of the time. See 才 + final 了? Sound the alarm.</div>`
    ...
    /* ------------------------------------------------ 9 */
    {
      ...
      items: [
        ...
        { tiles: ["他", "昨天", "半夜", "才", "回家"], py: "Tā zuótiān bànyè cái huí jiā.", en: "He didn't get home until the middle of the night yesterday.", hint: "Late event → 才, and notice: no 了 tile at all." },
        ...
        { tiles: ["办公室里", "就", "他", "一个人", "会", "说", "法语"], py: "Bàngōngshì li jiù tā yí gè rén huì shuō Fǎyǔ.", en: "He's the only person in the office who speaks French.", hint: "就 = 'only' jumps in front of the noun it limits." },
...
In the listening section, 就 and 才 are often the ONLY difference between “the man is impressed” and “the man is annoyed”. Train your ear to catch the single syllable after the time word — it usually IS the answer.</div>`
    ...
    /* ------------------------------------------------ 11 */
    {
      ...
      items: [
        ...
        { q: 'Arrange: <span class="zh">开始 / 电影 / 五分钟 / 才</span>', choices: ['<span class="zh">电影才开始五分钟。</span>', '<span class="zh">电影五分钟才开始。</span>', '<span class="zh">才电影开始五分钟。</span>', '<span class="zh">电影开始才五分钟了。</span>'], a: 0, expl: "才开始五分钟 = 'has only been running five minutes' — 才 + verb + small duration. Option B means it started five minutes late-ish (odd), and D plants the illegal 才…了." },
        ...
        { q: '<span class="zh">妈妈说，先写完作业___可以看电视。</span>', choices: ['<span class="zh">就</span>', '<span class="zh">才</span>', '<span class="zh">再</span>', '<span class="zh">都</span>'], a: 1, expl: "A parental condition: TV is unlocked ONLY after homework → 才可以. 就 would make it an easygoing 'then'; Mom's rule is stricter than that — and the exam knows the difference." }
      ]
    },
